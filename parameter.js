var mod = {
    ...
    MAX_STORAGE_ENERGY: { // stop storing energy when reached, regarding RCL
        4: 5000,
        5: 50000,
        6: 100000,
        7: 200000,
    ...
    MIN_STORAGE_ENERGY: { // prefer storing energy until reached, regarding RCL
        4: 1000,
        5: 5000,
        6: 10000,
        7: 25000,
    ...
    // TODO : enable w/e needed
    /*
    CHATTY: false, // creeps say their current action
    HONK: true, // HONK when stored path is blocked by other creeps
    OOPS: true, // Creeps say Oops when dropping energy during drop mining
    SAY_ASSIGNMENT: true, // say a symbol representing the assigned action
    SAY_PUBLIC: true, // creeps talk public
    DEBUG: true, // gimme some more details4
